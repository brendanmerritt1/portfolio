    ...
    <div className="flex h-full flex-col items-center gap-28 py-32 lg:pt-24 xs:pt-16">
      <div
        className={`flex h-fit w-fit gap-[8rem] px-[18rem] font-light 3xl:pl-[16rem] 3xl:pr-[10rem] 2xl:gap-[5rem]
                    xl:pl-[13rem] xl:pr-[8rem] lg:gap-[5rem] lg:px-[4rem] md:gap-[3rem] md:px-[3rem] sm:flex-col xs:px-[2.5rem] xxs:px-[2rem]`}
      >
              ...
              return (
                ...
                >
                  ...
                  <Arrow
                    ...
                    className="h-9 3xl:h-8 2xl:h-7 xl:h-[2.5vw] lg:h-[3.5vw] sm:h-[6vw] xs:h-[6.5vw] xxs:h-[7.5vw]"
                  />
                </Link>
              );
            })}
      ...
      {props.project.name != "nonogram" && (
        <div
          className={`flex flex-col gap-16 pl-[18rem] pr-[13rem] text-5xl font-light leading-normal text-darker-gray dark:text-off-white 3xl:pr-[10rem] 
                    ...
                    lg:text-[3.5vw] md:px-[5rem] md:text-[3.75vw] sm:text-[5vw] xs:px-[3rem] xs:text-[5.5vw] xs:leading-[1.85] xxs:px-[2rem]`}
        >
      ...
      {props.project.name != "nonogram" && (
        <div className="flex w-full justify-center">
          <img
            ...
            className="w-[50vw] rounded-xl lg:w-[60vw] sm:w-[70vw] xs:w-[80vw]"
          />
        </div>
      )}
    </div>
